...
const SideBar = () => {
  ...
  return (
    <div className={`bg-[#0e0e0e] md:h-[95vh] relative flex flex-col justify-between py-4 md:py-0 text-gray-100 px-6 rounded-3xl`}>
      <div className="flex flex-col gap-4">
        <div className="flex flex-row">
          ...
          />
          {open && <div className="mt-12 mx-auto right-0 absolute bg-black p-4 rounded-lg mr-1">
            <Items />
          </div>}
        </div>
